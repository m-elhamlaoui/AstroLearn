...
public class RecommendationServiceIntegrationTest extends BaseIntegrationTest {
    ...
    private void createTestArticles() {
        ...
        // Add votes to create different popularity levels
        articleService.voteArticle(articleId1, testUserId, new com.example.demo.dto.ArticleVoteRequestDTO(com.example.demo.model.VoteType.UP));
        articleService.voteArticle(articleId1, testUserId, new com.example.demo.dto.ArticleVoteRequestDTO(com.example.demo.model.VoteType.UP));
        articleService.voteArticle(articleId2, testUserId, new com.example.demo.dto.ArticleVoteRequestDTO(com.example.demo.model.VoteType.UP));
    }
