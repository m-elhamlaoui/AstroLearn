...
public class ReadingHistoryServiceIntegrationTest extends BaseIntegrationTest {
    ...
    void shouldLogReadingTime() {
        // When
        ReadingHistoryDTO readingHistory = readingHistoryService.logReadingTime(testUserId, articleId, 10);
        ...
        assertThat(readingHistory.timeSpentSeconds()).isEqualTo(10);
        assertThat(readingHistory.isRead()).isFalse(); // Not enough time to mark as read (threshold is 300 seconds)
    }
